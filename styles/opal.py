...
style = {'style_name': 'opal',
         'base_mpl_style': 'default',
         'marketcolors': {'candle': {'up': 'lightskyblue',
                                     'down': 'salmon'},
                          'edge': {'up': 'lightskyblue',
                                   'down': 'salmon'},
                          'wick': {'up': 'white',
                                   'down': 'white'},
                          'ohlc': {'up': 'lightskyblue',
                                   'down': 'salmon'},
                          'volume': {'up': 'lightskyblue',
                                     'down': 'salmon'},
                          'vcedge': {'up': 'lightskyblue',
                                     'down': 'salmon'},
                          'vcdopcod': False,
                          'alpha': 1.0},
         'mavcolors': ['mediumaquamarine',
                       'palevioletred',
                       'royalblue',
                       'darkslateblue'],
         'y_on_right': False,
