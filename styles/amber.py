...
style = {'style_name': 'amber',
         'base_mpl_style': 'default',
         'marketcolors': {'candle': {'up': 'lemonchiffon',
                                     'down': 'tomato'},
                          'edge': {'up': 'lemonchiffon',
                                   'down': 'tomato'},
                          'wick': {'up': 'white',
                                   'down': 'white'},
                          'ohlc': {'up': 'lemonchiffon',
                                   'down': 'tomato'},
                          'volume': {'up': 'lemonchiffon',
                                     'down': 'tomato'},
                          'vcedge': {'up': 'lemonchiffon',
                                     'down': 'tomato'},
                          'vcdopcod': False,
                          'alpha': 1.0},
         'mavcolors': ['lightskyblue',
                       'burlywood',
                       'indianred',
                       'maroon'],
         'y_on_right': False,
