...
style = {
    ...
    "marketcolors": {
        "candle": {"up": "peachpuff", "down": "mediumslateblue"},
        "edge": {"up": "peachpuff", "down": "mediumslateblue"},
        "wick": {"up": "white", "down": "white"},
        "ohlc": {"up": "peachpuff", "down": "mediumslateblue"},
        "volume": {"up": "peachpuff", "down": "mediumslateblue"},
        "vcedge": {"up": "peachpuff", "down": "mediumslateblue"},
        "vcdopcod": False,
        "alpha": 1.0,
    },
    "mavcolors": [
    ...
    "custom_style": {
        ...
        "profit_color": "peachpuff",
        "loss_color": "mediumslateblue",
        "closing_line": "--",
        "opening_line": "--",
        "entry_line": ":",
        "exit_line": ":",
